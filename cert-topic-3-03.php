...
<head>
<?php
$pageTitle = '3.03 DB Schema | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">3.03</div>
                    <h1 class="objective-title">DB Schema & Database Tables</h1>
                    <p class="mb-0">Master declarative schema for altering database tables using db_schema.xml, including tables, columns, indexes, foreign keys, and patches.</p>
                </div>

                <?php require 'includes/topics/3-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-3-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 3.02 Types of Attributes</a>
