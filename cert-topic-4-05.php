...
<head>
<?php
$pageTitle = '4.05 JavaScript (Basics) | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #0ea5e9 0%, #22d3ee 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.05</div>
                    <h1 class="objective-title">JavaScript (Basics)</h1>
                    <p class="mb-0">Given a scenario, work with JavaScript files: RequireJS module paths and aliases, module types, initialization patterns, and JS mixins.</p>
                </div>

                <?php require 'includes/topics/4-05/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-04.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.04 Theme Structure</a>
