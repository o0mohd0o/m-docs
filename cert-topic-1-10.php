...
<head>
<?php
$pageTitle = '1.10 Custom Module Routes | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-1-11.php" class="btn btn-primary float-end">Next: 1.11 URL Rewrites <i class="fas fa-arrow-right"></i></a>
                </div>
            </main>
        </div>
    </div>
