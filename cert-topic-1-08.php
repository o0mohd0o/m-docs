...
<head>
<?php
$pageTitle = '1.08 Localization | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.08</div>
                    <h1 class="objective-title">Localization</h1>
                    <p class="mb-0">Understanding internationalization, translation mechanisms, language packs, and database translations.</p>
                </div>
