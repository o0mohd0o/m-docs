...
<head>
<?php
$pageTitle = '4.03 Modify Page Style | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #10b981 0%, #22c55e 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.03</div>
                    <h1 class="objective-title">Modify Page Style</h1>
                    <p class="mb-0">Given a scenario, modify page styles: theme vs module placement, customize vs override LESS, fallback, and including third‑party CSS via layout.</p>
                </div>

                <?php require 'includes/topics/4-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.02 Modify Layout XML</a>
