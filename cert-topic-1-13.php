...
<head>
<?php
$pageTitle = '1.13 Stores, Websites, and Store Views | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.13</div>
                    <h1 class="objective-title">Stores, Websites, and Store Views</h1>
                    <p class="mb-0">Understanding the scope system is essential for managing multi-store Magento implementations with different languages, currencies, and pricing.</p>
                </div>

                <?php require 'includes/topics/1-13/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-1-12.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.12 Caching System</a>
