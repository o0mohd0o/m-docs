...
<head>
<?php
$pageTitle = 'Practice: 2.02 Admin Grid/Form | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">2.02</div>
                    <h1><i class="fas fa-th"></i> Admin Grid/Form Components</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-2-02.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 2.02
                    </a>
                </div>
            </main>
        </div>
