...
<head>
<?php
$pageTitle = '1.02 Module Structure | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .module-card { background: white; border-left: 4px solid #198754; padding: 20px; margin-bottom: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
        .file-path { background: #f8f9fa; padding: 8px 12px; border-radius: 4px; font-family: 'Courier New', monospace; color: #e83e8c; font-weight: 600; display: inline-block; margin-bottom: 15px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.02</div>
                    <h1 class="objective-title">Describe Module Structure</h1>
                    <p class="mb-0">Understanding the essential architecture and requirements of a Magento module.</p>
                </div>

                <?php require 'includes/topics/1-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-1-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.01 File Structure</a>
                    <a href="cert-topic-1-03.php" class="btn btn-primary float-end">Next: 1.03 di.xml Usage <i class="fas fa-arrow-right"></i></a>
                </div>
            </main>
        </div>
    </div>
