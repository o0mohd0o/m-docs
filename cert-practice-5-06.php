...
<head>
<?php
$pageTitle = 'Practice: 5.06 Tax, Currencies, Cart/Checkout Config | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">5.06</div>
                    <h1><i class="fas fa-cog"></i> Tax, Currencies, Cart/Checkout Config</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-5-06.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 5.06
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/5-06/questions.js"></script>
