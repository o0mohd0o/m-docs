...
<head>
<?php
$pageTitle = '6.04 Price Types & Calculation | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #064e3b 0%, #065f46 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">6.04</div>
                    <h1 class="objective-title">Price Types & Calculation</h1>
                    <p class="mb-0">Describe price types and generation: product page (base, special, catalog rules), cart (tiered, options, tax, cart rules), calculation process, customization, and price rendering.</p>
                </div>

                <?php require 'includes/topics/6-04/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-6-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 6.03 Catalog Price Rules</a>
