...
<head>
<?php
$pageTitle = 'Practice: 2.01 ACL & Roles | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">2.01</div>
                    <h1><i class="fas fa-user-shield"></i> ACL with Roles and Resources</h1>
                    <p class="mb-0">28 Questions</p>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-2-01.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 2.01
                    </a>
                </div>
            </main>
        </div>
