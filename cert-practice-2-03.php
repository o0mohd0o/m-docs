...
<head>
<?php
$pageTitle = 'Practice: 2.03 System Configuration | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">2.03</div>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-2-03.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 2.03
                    </a>
                </div>
            </main>
        </div>
