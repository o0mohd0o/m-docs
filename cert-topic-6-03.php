...
<head>
<?php
$pageTitle = '6.03 Catalog Price Rules | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #065f46 0%, #047857 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">6.03</div>
                    <h1 class="objective-title">Catalog Price Rules</h1>
                    <p class="mb-0">Describe catalog price rules: setup, indexing (catalogrule_product_price table), performance impact, debugging strategies, and comparison to special pricing.</p>
                </div>

                <?php require 'includes/topics/6-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-6-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 6.02 Product Types</a>
