...
<head>
<?php
$pageTitle = '1.2 Cloud Admin UI Settings | Commerce Cloud Fundamentals';
$pageType = 'lesson';
...
?>
    <style>
        ...
        .nav-link { color: #333; }
        .nav-link.active { font-weight: bold; color: #dc3545; }
        h2 { margin-top: 30px; padding-bottom: 10px; border-bottom: 1px solid #dee2e6; }
        h3 { margin-top: 25px; color: #dc3545; }
        ...
        .objective-header { background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        .directory-card { background: white; border-left: 4px solid #dc3545; padding: 20px; margin-bottom: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.2</div>
                    <h1 class="objective-title">Cloud Admin UI Settings</h1>
                    <p class="mb-0">Determine how to locate settings with Cloud Admin UI: Project settings, user management, environments, logs, and environment controls.</p>
                </div>

                <?php require 'includes/topics/cloud-1-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cloud-topic-1-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.1 Cloud Features</a>
                    <a href="cloud-overview.php" class="btn btn-danger"><i class="fas fa-arrow-up"></i> Back to Cloud Overview</a>
                </div>
            </main>
        </div>
    </div>
