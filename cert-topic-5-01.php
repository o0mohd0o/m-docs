...
<head>
<?php
$pageTitle = '5.01 Cart Components | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #ef4444 0%, #f97316 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.01</div>
                    <h1 class="objective-title">Cart Components</h1>
                    <p class="mb-0">Describe cart components from user and developer perspectives: Quote, items, addresses, totals, renderers, and quote merge behavior.</p>
                </div>

                <?php require 'includes/topics/5-01/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-06.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.06 Customer Data</a>
