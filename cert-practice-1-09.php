...
<head>
<?php
$pageTitle = 'Practice: 1.09 Cron Functionality | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">1.09</div>
                    <h1><i class="fas fa-clock"></i> Cron Functionality</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-1-09.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 1.09
                    </a>
                </div>
            </main>
        </div>
