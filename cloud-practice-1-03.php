...
<head>
<?php
$pageTitle = 'Practice: 1.3 Manage Users | Commerce Cloud Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="mt-4">
                    ...
                    <a href="cloud-topic-1-03.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 1.3
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/cloud-1-03/questions.js"></script>
