...
<head>
<?php
$pageTitle = 'Practice: 4.06 Customer Data (Private Content) | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">4.06</div>
                    <h1><i class="fas fa-user-check"></i> Customer Data (Private Content)</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-4-06.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 4.06
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/4-06/questions.js"></script>
