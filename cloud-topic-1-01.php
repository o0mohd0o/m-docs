...
<head>
<?php
$pageTitle = '1.1 Cloud Features & Functions | Commerce Cloud Fundamentals';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.1</div>
                    <h1 class="objective-title">Cloud Features & Functions</h1>
                    <p class="mb-0">Describe the features and functions of Magento Commerce Cloud: Platform overview, Starter vs Pro editions, branching workflows, and deployment processes.</p>
                </div>

                <?php require 'includes/topics/cloud-1-01/content.php'; ?>

                <div class="mt-4">
                    <a href="cloud-overview.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Cloud Overview</a>
                    <a href="cloud-topic-1-02.php" class="btn btn-danger"><i class="fas fa-arrow-right"></i> Next: 1.2 Cloud Admin UI</a>
                </div>
            </main>
        </div>
    </div>
