...
<head>
<?php
$pageTitle = '2.02 Admin Grid/Form Components | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">2.02</div>
                    <h1 class="objective-title">Admin Grid/Form Components</h1>
                    <p class="mb-0">Learn how to create and modify admin grids and forms using UI Components to manage custom entities in the Magento admin panel.</p>
                </div>

                <?php require 'includes/topics/2-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-2-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 2.01 ACL & Roles</a>
