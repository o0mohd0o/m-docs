...
<head>
<?php
$pageTitle = '5.06 Tax, Currencies, Cart/Checkout Config | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #581c87 0%, #7c2d12 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.06</div>
                    <h1 class="objective-title">Tax, Currencies, Cart/Checkout Config</h1>
                    <p class="mb-0">Given a scenario, configure tax rules (classes, rates, rules), currencies (scope, display), and cart/checkout settings (onepage, multishipping, guest, mini cart).</p>
                </div>

                <?php require 'includes/topics/5-06/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-5-05.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 5.05 Payment & Shipping</a>
