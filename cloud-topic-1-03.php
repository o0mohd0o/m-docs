...
<head>
<?php
$pageTitle = '1.3 Manage Users | Commerce Cloud Fundamentals';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.3</div>
                    <h1 class="objective-title">Manage Users</h1>
                    <p class="mb-0">Demonstrate the ability to manage users: Add SSH keys, add users to projects, manage roles (Admin, Contributor, Reader), and configure permissions.</p>
                </div>

                <?php require 'includes/topics/cloud-1-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cloud-topic-1-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.2 Cloud Admin UI</a>
