...
<head>
<?php
$pageTitle = 'Practice: 1.08 Localization | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">1.08</div>
                    <h1><i class="fas fa-language"></i> Localization</h1>
                    <p class="mb-0">22 Questions (Covers Parts a, b, c)</p>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-1-08.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 1.08
                    </a>
                </div>
            </main>
        </div>
