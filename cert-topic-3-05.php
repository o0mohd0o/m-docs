...
<head>
<?php
$pageTitle = '3.05 EAV Basics | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">3.05</div>
                    <h1 class="objective-title">EAV Basics</h1>
                    <p class="mb-0">Master the Entity Attribute Value framework - understanding entity types, attributes, attribute sets, and how values are stored with scope support.</p>
                </div>

                <?php require 'includes/topics/3-05/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-3-04.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 3.04 Models & Collections</a>
