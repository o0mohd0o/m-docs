...
<head>
<?php
$pageTitle = 'Practice: 4.04 Theme Structure | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">4.04</div>
                    <h1><i class="fas fa-sitemap"></i> Theme Structure</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-4-04.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 4.04
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/4-04/questions.js"></script>
