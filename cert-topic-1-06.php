...
<head>
<?php
$pageTitle = '1.06 CLI Commands | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .command-card { background: #f8f9fa; border: 2px solid #dee2e6; padding: 15px; margin: 10px 0; border-radius: 8px; }
        .command-card h5 { color: #0d6efd; margin-bottom: 10px; }
    </style>
</head>
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.06</div>
                    <h1 class="objective-title">Magento CLI Commands</h1>
                    <p class="mb-0">Understanding bin/magento commands in the development cycle.</p>
                </div>

                <?php require 'includes/topics/1-06/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-1-05.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.05 Create Controllers</a>
                    <a href="cert-topic-1-07.php" class="btn btn-primary float-end">Next: 1.07 Index Functionality <i class="fas fa-arrow-right"></i></a>
                </div>
            </main>
        </div>
    </div>
