...
<head>
<?php
$pageTitle = 'Practice: 3.04 Models & Collections | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">3.04</div>
                    <h1><i class="fas fa-database"></i> Models & Collections</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-3-04.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 3.04
                    </a>
                </div>
            </main>
        </div>
