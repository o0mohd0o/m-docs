...
<head>
<?php
$pageTitle = 'Practice: 3.01 Attribute Sets | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">3.01</div>
                    <h1><i class="fas fa-tags"></i> Attribute Sets & Attributes</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-3-01.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 3.01
                    </a>
                </div>
            </main>
        </div>
