...
<head>
<?php
$pageTitle = 'Practice: 6.03 Catalog Price Rules | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">6.03</div>
                    <h1><i class="fas fa-tags"></i> Catalog Price Rules</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-6-03.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 6.03
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/6-03/questions.js"></script>
