...
<head>
<?php
$pageTitle = '3.02 Types of Attributes | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">3.02</div>
                    <h1 class="objective-title">Types of Attributes</h1>
                    <p class="mb-0">Deep dive into EAV and Extension attributes - understanding their differences, use cases, and implementation approaches for extending Magento entities.</p>
                </div>

                <?php require 'includes/topics/3-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-3-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 3.01 Attribute Sets</a>
