...
<head>
<?php
$pageTitle = '4.02 Modify Layout XML | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.02</div>
                    <h1 class="objective-title">Modify Layout XML</h1>
                    <p class="mb-0">Given a scenario, modify layout: declare/move/remove blocks, containers, include handles, set templates, ordering, and handle cacheability.</p>
                </div>

                <?php require 'includes/topics/4-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.01 CMS Pages & Blocks</a>
