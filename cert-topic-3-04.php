...
<head>
<?php
$pageTitle = '3.04 Models & Collections | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">3.04</div>
                    <h1 class="objective-title">Models, Resource Models & Collections</h1>
                    <p class="mb-0">Master the four types of ORM classes in Magento: Models, Resource Models, Collections, and Repositories, and understand their responsibilities and relationships.</p>
                </div>

                <?php require 'includes/topics/3-04/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-3-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 3.03 DB Schema</a>
