...
<head>
<?php
$pageTitle = '4.04 Theme Structure | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #f59e0b 0%, #f97316 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.04</div>
                    <h1 class="objective-title">Theme Structure</h1>
                    <p class="mb-0">Describe theme locations, registration, folder structure, overrides, and required files for Composer/local themes.</p>
                </div>

                <?php require 'includes/topics/4-04/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.03 Modify Page Style</a>
