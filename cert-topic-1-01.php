        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.01</div>
                    <h1 class="objective-title">Describe Magento File Structure</h1>
                    <p class="mb-0">Understanding the foundational Magento file structure is essential for locating code, configuration, and assets quickly.</p>
                </div>
