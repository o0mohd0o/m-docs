...
<head>
<?php
$pageTitle = '6.02 Product Types | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #047857 0%, #059669 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">6.02</div>
                    <h1 class="objective-title">Product Types</h1>
                    <p class="mb-0">Describe product types: Simple, Virtual, Configurable, Grouped, Bundle. Understand use cases, parent-child relationships, quote/order behavior, and how to obtain products by type.</p>
                </div>

                <?php require 'includes/topics/6-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-6-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 6.01 Category & Product Management</a>
