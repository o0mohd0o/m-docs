...
<head>
<?php
$pageTitle = 'Practice: 5.01 Cart Components | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">5.01</div>
                    <h1><i class="fas fa-shopping-cart"></i> Cart Components</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-5-01.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 5.01
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/5-01/questions.js"></script>
