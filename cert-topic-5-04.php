...
<head>
<?php
$pageTitle = '5.04 Basic Usage of Quote Data | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #991b1b 0%, #b91c1c 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.04</div>
                    <h1 class="objective-title">Basic Usage of Quote Data</h1>
                    <p class="mb-0">Given a scenario, describe quote data usage: obtaining quotes, addresses (multi-shipping vs single), totals, items, item options, and product attributes in items.</p>
                </div>

                <?php require 'includes/topics/5-04/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-5-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 5.03 Checkout Modifications</a>
