...
<head>
<?php
$pageTitle = '1.04 Plugins, Preferences, and Observers | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.04</div>
                    <h1 class="objective-title">Plugins, Preferences, Event Observers & Interceptors</h1>
                    <p class="mb-0">Understanding the core architectural concepts for customizing Magento effectively.</p>
                </div>

                <?php require 'includes/topics/1-04/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-1-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 1.03 di.xml Usage</a>
                    <a href="cert-topic-1-05.php" class="btn btn-primary float-end">Next: 1.05 Create Controllers <i class="fas fa-arrow-right"></i></a>
                </div>
            </main>
        </div>
    </div>
