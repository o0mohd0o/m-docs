...
<head>
<?php
$pageTitle = '5.05 Payment & Shipping Methods | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #7c2d12 0%, #991b1b 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.05</div>
                    <h1 class="objective-title">Payment & Shipping Methods</h1>
                    <p class="mb-0">Given a scenario, configure payment and shipping methods: offline vs online shipping, TableRate CSV, payment types (offline, gateway, hosted), and payment actions (Authorize, Capture, Order).</p>
                </div>

                <?php require 'includes/topics/5-05/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-5-04.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 5.04 Quote Data Usage</a>
