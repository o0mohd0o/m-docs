...
<head>
<?php
$pageTitle = '4.06 Customer Data (Private Content) | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #14b8a6 0%, #06b6d4 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.06</div>
                    <h1 class="objective-title">Customer Data (Private Content)</h1>
                    <p class="mb-0">Describe front-end usage of customer data: client-side private content, customerData API, sections.xml, and invalidation to keep FPC enabled.</p>
                </div>

                <?php require 'includes/topics/4-06/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-4-05.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 4.05 JavaScript (Basics)</a>
