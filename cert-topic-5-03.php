...
<head>
<?php
$pageTitle = '5.03 Basic Checkout Modifications | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #b91c1c 0%, #dc2626 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.03</div>
                    <h1 class="objective-title">Basic Checkout Modifications</h1>
                    <p class="mb-0">Given a scenario, describe checkout modifications: flow, UiComponents, JS framework (actions/models/views), REST API, and order placement sequence.</p>
                </div>

                <?php require 'includes/topics/5-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-5-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 5.02 Cart Promo Rules</a>
