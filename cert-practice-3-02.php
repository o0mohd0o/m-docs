...
<head>
<?php
$pageTitle = 'Practice: 3.02 Types of Attributes | AD0-E717 Exam Prep';
$pageType = 'quiz';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">3.02</div>
                    <h1><i class="fas fa-layer-group"></i> Types of Attributes</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-3-02.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 3.02
                    </a>
                </div>
            </main>
        </div>
