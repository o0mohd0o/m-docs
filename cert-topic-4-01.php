...
<head>
<?php
$pageTitle = '4.01 CMS Pages & Blocks | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #0ea5e9 0%, #3b82f6 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">4.01</div>
                    <h1 class="objective-title">CMS Pages & Blocks</h1>
                    <p class="mb-0">Describe the usage of CMS pages, blocks, widgets, and Page Builder for building content without code, including Magento directive syntax.</p>
                </div>

                <?php require 'includes/topics/4-01/content.php'; ?>
