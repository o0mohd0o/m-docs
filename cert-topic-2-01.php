...
<head>
<?php
$pageTitle = '2.01 ACL with Roles and Resources | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">2.01</div>
                    <h1 class="objective-title">ACL with Roles and Resources</h1>
                    <p class="mb-0">Understanding how Access Control Lists (ACL) work with roles and resources is essential for securing the admin area and API endpoints.</p>
                </div>

                <?php require 'includes/topics/2-01/content.php'; ?>
