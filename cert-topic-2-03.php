...
<head>
<?php
$pageTitle = '2.03 System Configuration | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">2.03</div>
                    <h1 class="objective-title">System Configuration</h1>
                    <p class="mb-0">Master creating and managing system configuration options that allow store administrators to customize module behavior through the admin panel.</p>
                </div>

                <?php require 'includes/topics/2-03/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-2-02.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 2.02 Admin Grid/Form</a>
