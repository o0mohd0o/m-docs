...
<head>
<?php
$pageTitle = '5.02 Cart Promo Rules | AD0-E717 Certification Lesson';
$pageType = 'lesson';
...
?>
    ...
    <style>
        ...
        .objective-header { background: linear-gradient(135deg, #dc2626 0%, #ea580c 100%); color: white; padding: 30px; border-radius: 12px; margin-bottom: 30px; }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">5.02</div>
                    <h1 class="objective-title">Cart Promo Rules</h1>
                    <p class="mb-0">Describe promo rules: totals framework, conditions (EAV attributes), actions (percent, fixed, Buy X get Y), coupons, shipping, and tax interactions.</p>
                </div>

                <?php require 'includes/topics/5-02/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-5-01.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 5.01 Cart Components</a>
