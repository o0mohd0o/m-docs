...
<head>
<?php
$pageTitle = '3.01 Attribute Sets & Attributes | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">3.01</div>
                    <h1 class="objective-title">Attribute Sets & Attributes</h1>
                    <p class="mb-0">Master the concepts of attribute sets, attribute groups, and the differences between EAV and extension attributes for extending Magento entities.</p>
                </div>

                <?php require 'includes/topics/3-01/content.php'; ?>

                <div class="mt-4">
                    <a href="cert-topic-2-03.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Previous: 2.03 System Config</a>
