...
<head>
<?php
$pageTitle = 'Practice: 6.01 Category & Product Management | AD0-E717 Exam Prep';
$pageType = 'quiz';
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="quiz-header">
                    <div class="topic-badge">6.01</div>
                    <h1><i class="fas fa-sitemap"></i> Category & Product Management</h1>
                ...
                <div class="mt-4">
                    ...
                    <a href="cert-topic-6-01.php" class="btn btn-outline-secondary">
                        <i class="fas fa-book"></i> Study Topic 6.01
                    </a>
                </div>
            </main>
        </div>
    ...
    <script src="includes/practice/6-01/questions.js"></script>
