...
<head>
<?php
$pageTitle = '1.07 Index Functionality | AD0-E717 Certification Lesson';
$pageType = 'lesson';
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="objective-header">
                    <div class="objective-number">1.07</div>
                    <h1 class="objective-title">Index Functionality</h1>
                    <p class="mb-0">Deep dive into indexing concepts: performance vs redundancy, price calculations, change logs, MySQL triggers, index modes, and available indexes.</p>
                </div>
